...
type AddAppRequest struct {
	...
	TtlHour  int32  `protobuf:"varint,4,opt,name=ttl_hour,json=ttlHour,proto3" json:"ttl_hour,omitempty"`
}
...
func (x *AddAppRequest) GetTtlHour() int32 {
	if x != nil {
		return x.TtlHour
	}
	return 0
...
func (x *AddAppResponse) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x72, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x41, 0x70, 0x70, 0x52,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x19,
	0x0a, 0x08, 0x74, 0x74, 0x6c, 0x5f, 0x68, 0x6f, 0x75, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x07, 0x74, 0x74, 0x6c, 0x48, 0x6f, 0x75, 0x72, 0x22, 0x27, 0x0a, 0x0e, 0x41, 0x64, 0x64,
	...
	0x49, 0x64, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xa8, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x33, 0x0a,
	0x06, 0x41, 0x64, 0x64, 0x41, 0x70, 0x70, 0x12, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41,
	0x64, 0x64, 0x41, 0x70, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x41, 0x64, 0x64, 0x41, 0x70, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x0e, 0x5a, 0x0c, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*AddAppRequest)(nil),    // 0: auth.AddAppRequest
	(*AddAppResponse)(nil),   // 1: auth.AddAppResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.AddApp:input_type -> auth.AddAppRequest
	2, // 1: auth.Auth.Register:input_type -> auth.RegisterRequest
	4, // 2: auth.Auth.Login:input_type -> auth.LoginRequest
	1, // 3: auth.Auth.AddApp:output_type -> auth.AddAppResponse
